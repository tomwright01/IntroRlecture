...
X <- read.table("/Users/chris/Desktop/SickKidsWorkshop/mydeck/DataExamples/VAlung.txt",header=TRUE,sep="\t")
dim(X)
head(X, n=2)

X <- read.csv("/Users/chris/Desktop/SickKidsWorkshop/mydeck/DataExamples/VAlung.csv",header=TRUE)
head(X, n=2)
X <- read.table("/Users/chris/Desktop/SickKidsWorkshop/mydeck/DataExamples/VAlung.csv",header=TRUE, sep=",")
head(X, n=2)
...
## .xls file extension
X <- loadWorkbook("/Users/chris/Desktop/SickKidsWorkshop/mydeck/DataExamples/VAlung.xls")
Y <- readWorksheet(X, sheet = "VAlung", header = TRUE)
head(Y,n=1)
## .xlsx file extension
A <- loadWorkbook("/Users/chris/Desktop/SickKidsWorkshop/mydeck/DataExamples/VAlung.xlsx")
...
## .xlsx file extension
A <- read.xlsx("/Users/chris/Desktop/SickKidsWorkshop/mydeck/DataExamples/VAlung.xlsx", sheetName="VAlung")
head(A,n=1)


## foreign
suppressPackageStartupMessages(library(foreign))
stata <- read.dta("/Users/chris/Desktop/SickKidsWorkshop/mydeck/DataExamples/VAlung.dta")
head(stata, n=1)

suppressPackageStartupMessages(library(foreign))
spss <- read.spss("/Users/chris/Desktop/SickKidsWorkshop/mydeck/DataExamples/valung.sav",to.data.frame=TRUE)
head(spss, n=1)
...
suppressPackageStartupMessages(library(datasets))
head(cars,2)
write.csv(x=cars, file="/Users/chris/Desktop/SickKidsWorkshop/mydeck/DataExamples/cars.csv", row.names=FALSE)
