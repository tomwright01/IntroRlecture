...
<div style='text-align: center;'>
    <img height='400' src='/Users/chris/Documents/SickKidsMaterials/Rlecture/LectureImages/RConsoleMac.png' />
</div>
...
```{r,echo=TRUE,results='markup'}
X <- read.table("/Users/chris/Documents/SickKidsMaterials/Rlecture/DataExamples/VAlung.txt",header=TRUE,sep="\t")
dim(X)
head(X, n=2)
```
...
```{r,echo=TRUE,results='markup'}
X <- read.csv("/Users/chris/Documents/SickKidsMaterials/Rlecture/DataExamples/VAlung.csv",header=TRUE)
head(X, n=2)
X <- read.table("/Users/chris/Documents/SickKidsMaterials/Rlecture/DataExamples/VAlung.csv",header=TRUE, sep=",")
head(X, n=2)
```
...
## .xls file extension
X <- loadWorkbook("/Users/chris/Documents/SickKidsMaterials/Rlecture/DataExamples/VAlung.xls")
Y <- readWorksheet(X, sheet = "VAlung", header = TRUE)
head(Y,n=1)
## .xlsx file extension
A <- loadWorkbook("/Users/chris/Documents/SickKidsMaterials/Rlecture/DataExamples/VAlung.xlsx")
...
## .xlsx file extension
A <- read.xlsx("/Users/chris/Documents/SickKidsMaterials/Rlecture/DataExamples/VAlung.xlsx", sheetName="VAlung")
head(A,n=1)
```
...
stata <- read.dta("/Users/chris/Documents/SickKidsMaterials/Rlecture/DataExamples/VAlung.dta")
head(stata, n=1)
```
...
```{r, echo=TRUE, results='markup'}
suppressPackageStartupMessages(library(foreign))
spss <- read.spss("/Users/chris/Documents/SickKidsMaterials/Rlecture/DataExamples/valung.sav",to.data.frame=TRUE)
head(spss, n=1)
```
...
suppressPackageStartupMessages(library(datasets))
head(cars,2)
write.csv(x=cars, file="/Users/chris/Documents/SickKidsMaterials/Rlecture/DataExamples/cars.csv", row.names=FALSE)
```
